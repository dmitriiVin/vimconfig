...
function! ShowVimCommandsHelp() abort
    ...
    let l:help_lines = [
                ...
                \ '  \gp             - Git push',
                \ '  \gl             - Git pull',
                \ '  \go             - открыть файл/репозиторий в GitHub',
                \ '  \gb             - переключить ветку Git (интерактивно)',
                \ '  \gn             - создать и переключить новую ветку Git',
                \ '  \gv             - переключить Git worktree (другая версия кода)',
                \ '',
                ...
                \ '  Esc / q         - закрыть справку и вернуться в код',
                \ '',
                \ 'Примечание:',
