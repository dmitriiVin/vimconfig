...
function! ShowVimCommandsHelp() abort
    ...
    let l:help_lines = [
                ...
                \ '  Ctrl+C          - копировать выделение в системный буфер',
                \ '  Ctrl+A          - выделить все',
                \ '  Ctrl+D / Ctrl+K - удалить строку/выделение',
                \ '  Ctrl+F          - поиск',
                \ '  \nh             - убрать подсветку поиска',
                \ '  Ctrl+N          - новый файл (в рабочей области)',
                \ '  Ctrl+X          - закрыть текущий буфер',
                \ '  Ctrl+B          - закрыть текущий буфер (pinned не закрывается)',
                \ '  F2              - переименовать текущий файл',
                \ '  F5              - запуск кода по типу файла',
                \ '  Tab / Shift+Tab - переключение по рабочим буферам',
                \ '  1..9,0          - переход по рабочим буферам (0 = 10-й)',
                ...
                \ '',
                \ 'Терминал:',
                \ '  Ctrl+T          - открыть/закрыть терминал внизу (toggle, вместо quickfix)',
                \ '',
                \ 'Буферы и файлы:',
                \ '  \x              - закрыть текущий буфер',
                \ '  \bd             - закрыть текущий буфер',
                \ '  \bp             - pin/unpin текущего буфера',
                \ '  \bo             - закрыть все буферы, кроме текущего и pinned',
                \ '  \bl             - список буферов',
                \ '  \ct             - показать текущий выбранный CMake-таргет',
                \ '  Ctrl+O          - открыть файл (path completion)',
                \ '  Ctrl+E          - открыть файл из директории текущего файла',
                \ '  Ctrl+P          - поиск файла по имени',
                \ '  Ctrl+Tab        - вернуться к предыдущему буферу',
                \ '  Alt+O           - безопасное открытие файла',
                \ '  \cd             - перейти в директорию текущего файла',
                \ '  \pwd            - показать текущий путь',
                \ '  \md             - создать директорию (mkdir -p ...)',
                \ '  \ex             - открыть проводник в текущей директории',
                \ '',
                \ 'NERDTree:',
                ...
                \ '  i               - сделать выбранную папку корнем дерева',
                \ '',
                \ 'CMake:',
                ...
                \ '  \z              - быстро копировать файлы между debug/release',
                \ '  \pc             - копировать файлы debug/release (all или выбор по номерам)',
                \ '',
                ...
                \ '  Ctrl+G / Ctrl+H - первая/последняя ошибка',
                \ '  \qn / \qp       - следующая/предыдущая ошибка',
                \ '  \qf / \ql       - первая/последняя ошибка',
                \ '',
                \ 'Автодополнение и ввод:',
                \ '  Tab             - принять подсказку (Insert mode)',
                \ '  Shift+Tab       - предыдущая подсказка (Insert mode)',
                \ '  Enter           - принять подсказку (Insert mode)',
                \ '  Tab             - автодополнение в командной строке',
                \ '  Shift+Tab       - обратный перебор в командной строке',
                \ '  Ctrl+Space      - показать все варианты в командной строке',
                \ '  "" () [] {}     - автозакрытие кавычек и скобок (Insert mode)',
                \ '',
                \ 'Git/Fugitive:',
                \ '  \gs             - Git status',
                \ '  \gc             - Git commit',
